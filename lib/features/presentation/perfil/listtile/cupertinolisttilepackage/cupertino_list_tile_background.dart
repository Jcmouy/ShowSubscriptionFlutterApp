...
typedef GetRectCallback = RectCallback Function(RenderBox referenceBox);
typedef CheckContext = bool Function(BuildContext context);
...
class _ListTileBackgroundStateWidget extends StatefulWidget {
  ...
  final FocusNode focusNode;
  final bool canRequestFocus;
  final GetRectCallback getRectCallback;
  final CheckContext debugCheckContext;
