...
class WelcomeSlide3 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      color: palette.BackGround.fondoWelcomeSlide3,
      child: Column(
        ...
        children: <Widget>[
          Center(
            child: Stack(
              children: <Widget>[
                Image.asset(
                  'assets/images/adventurer_f.png',
                  width: 250.0,
                  height: 250.0,
                  fit: BoxFit.cover,
                ),
          ...
          Column(
            children: <Widget>[
              Text(
                S.current.slide_3_title,
                style: WelcomeStyles.title,
              ),
              Text(
                S.current.slide_3_desc_1,
                style: WelcomeStyles.text,
              ),
              Text(
                S.current.slide_3_desc_2,
                style: WelcomeStyles.text,
              ),
              Text(
                S.current.slide_3_desc_3,
                style: WelcomeStyles.text,
              ),
            ],
          ),
